...
/*
 * Some custom player-model exporters emit this render mode:
 *
 *   E200001C 0C187878
 *
 * The second-cycle render mode uses coverage/translucent-style behavior
 * which makes triangle boundaries visibly appear like a wireframe on OoT/MM.
 *
 * Replace only that exact G_SETOTHERMODE_L command with:
 *
 *   E200001C 0C192078
 *
 * This keeps the model's original first-cycle PASS behavior while changing
 * the second cycle to the normal opaque Z-buffered surface mode.
 *
 * The replacement was verified against affected Linkle models.
 */
