...
export function worldConfig(world: LogicResultWorld, settings: Settings): Set<Confvar> {
  ...
  const exprs: { [k in Confvar]: boolean } = {
    ...
    OOT_PROGRESSIVE_BIGGORON_SWORD: settings.progressiveSwordsOot === 'progressive' || (!settings.sharedBiggoronSword && settings.progressiveBiggoronSwordOot === 'progressive') || (settings.sharedBiggoronSword && settings.progressiveBiggoronSwordShared === 'progressive'),
    MM_PROGRESSIVE_BIGGORON_SWORD: (!settings.sharedBiggoronSword && settings.progressiveBiggoronSwordMm === 'progressive') || (settings.sharedBiggoronSword && settings.progressiveBiggoronSwordShared === 'progressive'),
    MM_MASTER_SWORD: settings.masterSwordMm,
    MM_BIGGORON_SWORD: settings.biggoronSwordMm,
    SHARED_CHILD_SWORDS: settings.sharedChildSwords,
    SHARED_MASTER_SWORD: settings.sharedMasterSword,
    SHARED_BIGGORON_SWORD: settings.sharedBiggoronSword,
    ...
    MM_SHIELD_HYLIAN: settings.hylianShieldMm,
