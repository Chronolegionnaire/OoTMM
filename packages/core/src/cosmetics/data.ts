...
export const COSMETICS = [{
  ...
  key: 'modelMmChildLink',
  name: 'Player Model - Child Link (MM)',
  type: 'file',
  ext: 'zobj,pak',
  cond: hasMM,
}, {
  key: 'modelMmAdultLink',
  name: 'Player Model - Adult Link (MM)',
  type: 'file',
  ext: 'zobj,pak',
  cond: hasMM,
}, {
  key: 'voiceOotChildLink',
  name: 'Player Voice - Child Link (OoT)',
  type: 'file',
  ext: 'pak,zip',
  cond: hasOoT,
}, {
  key: 'voiceOotAdultLink',
  name: 'Player Voice - Adult Link (OoT)',
  type: 'file',
  ext: 'pak,zip',
  cond: hasOoT,
}, {
  key: 'voiceMmChildLink',
  name: 'Player Voice - Child Link (MM)',
  type: 'file',
  ext: 'pak,zip',
  cond: hasMM,
}, {
  key: 'voiceMmAdultLink',
  name: 'Player Voice - Adult Link (MM)',
  type: 'file',
  ext: 'pak,zip',
  cond: hasMM,
}, {
