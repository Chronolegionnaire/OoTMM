...
export const SETTINGS = [{
  ...
  type: 'enum',
  description:
      'Controls how Giant\'s Knife and Biggoron Sword are added to Majora\'s Mask.',
  values: [
    {
      value: 'none',
      name: 'None',
      description:
          'Giant\'s Knife and Biggoron Sword are not added to Majora\'s Mask.',
    },
    {
      value: 'separate',
      name: 'Separate',
      description:
          'Adds Giant\'s Knife and Biggoron Sword to MM as two separate items.',
    },
    {
      value: 'progressive',
      name: 'Progressive',
      description:
          'Adds Giant\'s Knife and Biggoron Sword to MM as a two-item progressive chain.',
    },
    {
      value: 'shared',
      name: 'Shared with OoT',
      description:
          'Adds Giant\'s Knife and Biggoron Sword to MM and shares them with OoT. Their progression follows the OoT Swords setting.',
      cond: hasOoTMM,
    },
  ],
  default: 'none',
  ...
  category: 'items.shared',
  type: 'boolean',
  description: 'When you obtain a shield, the opposite game\'s equivalent is given to you as well. With this, the Hylian and Hero\'s Shields are considered equivalent and you will be granted both in Majora\'s Mask.<br>If Shields are Progressive, all Shields are combined into three progressive items: Deku Shield -> Hylian/Hero\'s Shield -> Mirror Shield',
  default: false,
